...
public class VisibilityReportControl extends ReportTypeControl
{
    ...
    public VisibilityReportControl(Composite parentControl)
    {
        super("Visibility Report", parentControl);
    }

    public VisibilityReportControl(String name, Composite parentControl)
    {
    ...
    protected void createDefaultReportHeader()
    {
        ...
        long duration = Math.round(stop.durationFrom(start));
