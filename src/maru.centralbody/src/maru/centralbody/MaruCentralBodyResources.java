...
public enum MaruCentralBodyResources implements IMaruPluginResource
{
...
//    MAP_MOON_1("images/moonmap2k.jpg", "James Hastings-Trew's Moon", "http://planetpixelemporium.com/earth.html", ""),
    ...
    MaruCentralBodyResources(String path, String name)
    {
        this(path, name, "", "");
    }

    MaruCentralBodyResources(String path, String name, String url, String license)
    {
    ...
    public static MaruCentralBodyResources fromName(String name)
    {
        return MaruPluginResource.fromName(MaruCentralBodyResources.class, name);
    }

    public static MaruCentralBodyResources fromPath(String path)
    {
        return MaruPluginResource.fromPath(MaruCentralBodyResources.class, path);
    }
}
