...
public class InitialCustomCoordinate extends OrekitCoordinate
{
    ...
    public InitialCustomCoordinate(Orbit orbit)
    {
        super(orbit.getPVCoordinates(), orbit.getDate(), orbit.getFrame());
     ...
     */
    public static InitialCustomCoordinate recreate(InitialCustomCoordinate coordinate,
                                                   ICentralBody centralBody)
    {
        Orbit orbit = coordinate.getOrbit();
        return new InitialCustomCoordinate(recreate(orbit, centralBody));
    }

    /**
     * Recreate an orbit in case the central body changed.
     */
    public static Orbit recreate(Orbit orbit, ICentralBody centralBody)
    {
