...
public class InitialTLECoordinate extends OrekitCoordinate
{
    ...
    public InitialTLECoordinate(ICentralBody centralBody, String name, TLE tle) throws OrekitException
    {
        super(centralBody, coordinatesFromTle(tle), tle.getDate(), FramesFactory.getTEME());
