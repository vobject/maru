...
public abstract class NetworkScenarioModelAdapterEx extends NetworkScenarioModelAdapter
{
    public NetworkScenarioModelAdapterEx(Socket client) throws IOException
    {
        super(client);
    }
