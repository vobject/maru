 ...
 * <p>
 * This class is based on the article http://hexapixel.com/2009/01/12/rcp-workspaces
 * <p>
...
public class PickWorkspaceDialog extends TitleAreaDialog {
    ...
    public static final String  WS_IDENTIFIER          = ".maru_" + MaruPlugin.getDefault().getBundle().getVersion().toString();
    ...
    private static Preferences  _preferences           = Preferences.userNodeForPackage(MaruPlugin.class);

    // various dialog messages
    private static final String _StrMsg                = "Maru stores your projects in a folder called a workspace.\r\nChoose a workspace folder to use for this session.";
    private static final String _StrInfo               = "Select the workspace directory to use.";
    ...
    private final boolean             _switchWorkspace;
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        try {
            ...
            inner.setLayoutData(new GridData(GridData.FILL_VERTICAL | GridData.FILL_HORIZONTAL));
            ...
            _workspacePathCombo.setLayoutData(new GridData(400, SWT.DEFAULT));
            ...
            GridData data = (GridData) browse.getLayoutData();
            ...
            browse.addListener(SWT.Selection, new Listener() {
                ...
                public void handleEvent(Event event)
                {
                    ...
                    dd.setText("Select Workspace Directory");
                    ...
                    if (pick == null)
                    {
                        if (_workspacePathCombo.getText().length() == 0) {
            ...
            _RememberWorkspaceButton.setText("Use this as the default and do not ask again");
            GridData _RememberWorkspaceButtonData = new GridData(GridData.GRAB_VERTICAL | GridData.VERTICAL_ALIGN_END);
            _RememberWorkspaceButtonData.horizontalSpan = 3;
            _RememberWorkspaceButton.setLayoutData(_RememberWorkspaceButtonData);
    ...
    // suggests a path based on the user.dir/workspace directory location
    private String getWorkspacePathSuggestion() {
        StringBuffer buf = new StringBuffer();

        String uDir = System.getProperty("user.dir");
        if (uDir == null) {
            uDir = "c:" + File.separator + "temp";
        }
