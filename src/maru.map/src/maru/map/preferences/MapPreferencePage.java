...
public class MapPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage
{
    ...
    public void createFieldEditors()
    {
        ...
        addField(new BooleanFieldEditor(PreferenceConstants.P_MAP_SHOW_VISIBILITY_CIRCLES,
                                        "Show visibility circles (buggy around poles)",
                                        getFieldEditorParent()));
        addField(new BooleanFieldEditor(PreferenceConstants.P_MAP_SHOW_VISIBILITY_SC_TO_SC,
                                        "Show visibility lines between spacecrafts",
                                        getFieldEditorParent()));
        addField(new BooleanFieldEditor(PreferenceConstants.P_MAP_SHOW_VISIBILITY_SC_TO_GS,
                                        "Show visibility lines between spacecrafts and ground stations",
                                        getFieldEditorParent()));
