...
public class PreferenceInitializer extends AbstractPreferenceInitializer
{
    ...
    public void initializeDefaultPreferences()
    {
        ...
        store.setDefault(PreferenceConstants.P_MAP_GROUNDTRACK_STEP_SIZE, 90L);
        store.setDefault(PreferenceConstants.P_MAP_GROUNDTRACK_LENGTH, 2L);

        store.setDefault(PreferenceConstants.P_MAP_SHOW_VISIBILITY_CIRCLES, false);
        store.setDefault(PreferenceConstants.P_MAP_SHOW_VISIBILITY_SC_TO_SC, true);
        store.setDefault(PreferenceConstants.P_MAP_SHOW_VISIBILITY_SC_TO_GS, true);

        store.setDefault(PreferenceConstants.P_MAP_NIGHT, true);
        store.setDefault(PreferenceConstants.P_MAP_NIGHT_STEPSIZE, 2);
