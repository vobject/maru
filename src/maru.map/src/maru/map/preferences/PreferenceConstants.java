...
public class PreferenceConstants
{
    ...
    public static final String P_MAP_SHOW_ACCESS_SC_TO_SC = "mapShowAccessScToScPreference";
    public static final String P_MAP_SHOW_ACCESS_SC_TO_GS = "mapShowAccessScToGsPreference";
